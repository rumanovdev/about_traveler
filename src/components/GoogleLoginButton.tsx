...
const GoogleLoginButton = ({ redirectUri }: GoogleLoginButtonProps) => {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border bg-card hover:bg-accent transition-colors text-sm font-medium text-foreground disabled:opacity-50"
    >
