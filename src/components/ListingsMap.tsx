...
const ListingsMap = ({ listings, hoveredId, center }: ListingsMapProps) => {
  ...
  // Update markers whenever listings change or map becomes ready
  useEffect(() => {
      ...
      const marker = L.marker([listing.latitude, listing.longitude], { icon })
        ...
        .bindPopup(`
          <div style="min-width:160px">
            ...
            ${listing.price_from ? `<p style="margin:4px 0 0;font-size:12px;color:#555">από €${Math.round(listing.price_from)}</p>` : ""}
